...
//             <div className="bg-neutral-900/60 backdrop-blur-xl border border-white/5 rounded-[32px] p-8 transition-all duration-300 ease-out hover:border-[#a78bfa]/50 hover:-translate-y-2 hover:shadow-2xl">
...
//           <h2 className="text-3xl sm:text-4xl font-bold mb-8 tracking-tight flex items-center gap-3 relative before:absolute before:-bottom-2 before:left-0 before:w-32 before:h-[3px] before:bg-gradient-to-r before:from-[#a78bfa] before:to-[#60a5fa]">
//             Technical <span className="bg-white/5 px-3 py-1 rounded-full text-sm font-normal backdrop-blur-sm border border-white/5">Skills</span>
//           </h2>
          
//           <div className="bg-neutral-900/60 backdrop-blur-xl border border-white/5 rounded-[32px] p-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
//             <div>
//               <h3 className="text-base font-bold text-[#a78bfa] mb-4 flex items-center gap-2">💻 Languages</h3>
//               <div className="flex flex-wrap gap-2.5">
//                 {['JavaScript (ES6+)', 'HTML5', 'CSS3'].map((skill) => (
//                   <span key={skill} className="bg-[#a78bfa]/10 border border-[#a78bfa]/30 px-4 py-2 rounded-full text-sm text-neutral-200 transition-all duration-300 hover:bg-[#a78bfa]/30 hover:-translate-y-1 hover:shadow-[0_4px_12px_rgba(167,139,250,0.2)]">{skill}</span>
//                 ))}
//               </div>
//             </div>
...
//             <div>
//               <h3 className="text-base font-bold text-[#a78bfa] mb-4 flex items-center gap-2">📱 Architecture</h3>
//               <div className="flex flex-wrap gap-2.5">
//                 {['Responsive Design', 'Performance Optimization', 'Clean Code', 'REST APIs'].map((skill) => (
//                   <span key={skill} className="bg-[#a78bfa]/10 border border-[#a78bfa]/30 px-4 py-2 rounded-full text-sm text-neutral-200 transition-all duration-300 hover:bg-[#a78bfa]/30 hover:-translate-y-1 hover:shadow-[0_4px_12px_rgba(167,139,250,0.2)]">{skill}</span>
//                 ))}
//               </div>
//             </div>
...
//           <Card className="bg-neutral-900/60 backdrop-blur-xl border border-white/5 rounded-[32px] p-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
...
//             <Card className="bg-neutral-900/60 backdrop-blur-xl border border-white/5 rounded-[32px] p-8 transition-all duration-300 ease-out hover:border-[#a78bfa]/50 hover:-translate-y-2 hover:shadow-2xl">
//               <CardContent className="p-0">
//                 <h3 className="text-base font-bold text-[#a78bfa] mb-4 flex items-center gap-2">💻 Languages</h3>
//                 <div className="flex flex-wrap gap-2.5">
//                   {['JavaScript (ES6+)', 'HTML5', 'CSS3'].map((skill) => (
